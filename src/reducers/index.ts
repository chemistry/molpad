import { Reducer, StoreState, ToolMode } from '../declarations/index.js';
import { cursorReducer } from './cursor.reducer.js';
...
import { preCombinedReducer } from './pre-combined.reducer.js';
...
export const rootReducer: Reducer<StoreState> = (state, action) => {
