import { JMolAtomWrap, JMolWrapModel, StoreState } from '../declarations/index.js';

export class MoleculeCalcsHelper {
  public static proposeEndAtom(
  ...
  private static getNeighbours(molecule: JMolWrapModel, atom: JMolAtomWrap): JMolAtomWrap[] {
    ...
    const neighbourAtomIds = Object.keys(molecule.bonds)
      .map((bondId) => {
